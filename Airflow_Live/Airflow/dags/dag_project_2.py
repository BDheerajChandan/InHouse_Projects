# Airflow/dags/dag_project_2.py
"""
DAG: dag_project_2
Tasks (ON trigger  — default or conf={"action":"start"}):
  1. setup_venv      — creates venv, pip-installs backend requirements
  2. setup_frontend  — runs npm install inside container
  3. start_backend   — launches backend (non-blocking)
